...
public:
    ...
    /** @name Base
      * @{ */
        ...
        /** Defines extra-data value corresponding to passed @a strKey as strValue.
          * If valid @a uID is set => applies to machine extra-data, otherwise => to global one. */
        bool setExtraDataString(const QString &strKey,
        ...
        /** Defines extra-data value corresponding to passed @a strKey as value.
          * If valid @a uID is set => applies to machine extra-data, otherwise => to global one. */
        bool setExtraDataStringList(const QString &strKey,
    ...
    /** @name General
      * @{ */
        ...
        bool setRestrictedDialogTypes(UIExtraDataMetaDefs::DialogType enmTypes, const QUuid &uID);
    ...
    /** @name Messaging
      * @{ */
        ...
        bool setSuppressedMessages(const QStringList &list);
        ...
        bool setKeepSuccessfullNotificationProgresses(bool fKeep);
        ...
        bool setNotificationCenterAlignment(Qt::Alignment enmOrder);

        /** Returns notification-center order. */
        Qt::SortOrder notificationCenterOrder();
        /** Defines notification-progresses @a enmOrder. */
        bool setNotificationCenterOrder(Qt::SortOrder enmOrder);
    ...
    /** @name Application Update
      * @{ */
        ...
        bool incrementApplicationUpdateCheckCounter();
    /** @} */
    ...
    /** @name Settings: Storage
      * @{ */
        ...
        bool setRecentFolderForHardDrives(const QString &strValue);
        /** Defines recent folder for optical-disk as @a strValue. */
        bool setRecentFolderForOpticalDisks(const QString &strValue);
        /** Defines recent folder for floppy-disk as @a strValue. */
        bool setRecentFolderForFloppyDisks(const QString &strValue);
        ...
        bool setRecentListOfHardDrives(const QStringList &value);
        /** Defines the list of recently used optical-disks as @a value. */
        bool setRecentListOfOpticalDisks(const QStringList &value);
        /** Defines the list of recently used floppy-disks as @a value. */
        bool setRecentListOfFloppyDisks(const QStringList &value);
    /** @} */
    ...
    /** @name VISO Creator
      * @{ */
        ...
        bool setVISOCreatorRecentFolder(const QString &strValue);
    ...
    /** @name VirtualBox Manager
      * @{ */
        ...
        bool setSelectorWindowGeometry(const QRect &geometry, bool fMaximized);

        /** Returns selector-window splitter hints. */
        QList<int> selectorWindowSplitterHints();
        /** Defines selector-window splitter @a hints. */
        bool setSelectorWindowSplitterHints(const QList<int> &hints);
        ...
        bool setSelectorWindowToolBarVisible(bool fVisible);
        ...
        bool setSelectorWindowToolBarTextVisible(bool fVisible);
        ...
        bool setToolsPaneLastItemsChosen(UIToolType enmTypeGlobal,
                                         UIToolType enmTypeMachine);
        ...
        bool setSelectorWindowStatusBarVisible(bool fVisible);
        ...
        bool setMachineGroupDefinitions(const QString &strGroupID, const QStringList &definitions);
        ...
        bool setSelectorWindowLastItemChosen(const QString &strItemID);
        ...
        bool setSelectorWindowDetailsElements(const QMap<DetailsElementType, bool> &elements);
        ...
        bool setSelectorWindowPreviewUpdateInterval(PreviewUpdateIntervalType interval);
        ...
        bool setVBoxManagerDetailsPaneElementOptions(DetailsElementType enmElementType, const QStringList &options);
    /** @} */
    ...
    /** @name Snapshot Manager
      * @{ */
        ...
        bool setSnapshotManagerDetailsExpanded(bool fExpanded);
    /** @} */
    ...
    /** @name Virtual Media Manager
      * @{ */
        ...
        bool setVirtualMediaManagerDetailsExpanded(bool fExpanded);
        ...
        bool setVirtualMediaManagerSearchWidgetExpanded(bool fExpanded);
    /** @} */
    ...
    /** @name Host Network Manager
      * @{ */
        ...
        bool setHostNetworkManagerDetailsExpanded(bool fExpanded);
    /** @} */
    ...
    /** @name Cloud Profile Manager
      * @{ */
        ...
        bool setCloudProfileManagerRestrictions(const QStringList &restrictions);
        ...
        bool setCloudProfileManagerDetailsExpanded(bool fExpanded);
    /** @} */
    ...
    /** @name Cloud Console Manager
      * @{ */
        ...
        bool setCloudConsoleManagerApplication(const QString &strId, const QString &strDefinition);
        ...
        bool setCloudConsoleManagerProfile(const QString &strApplicationId, const QString &strProfileId, const QString &strDefinition);
        ...
        bool setCloudConsoleManagerRestrictions(const QStringList &restrictions);
        ...
        bool setCloudConsoleManagerDetailsExpanded(bool fExpanded);
    /** @} */
    ...
    /** @name Cloud Console
      * @{ */
        ...
        bool setCloudConsolePublicKeyPath(const QString &strPath);
    /** @} */
    ...
    /** @name Virtual Machine
      * @{ */
        ...
        bool setMachineWindowGeometry(UIVisualStateType visualStateType, ulong uScreenIndex, const QRect &geometry, bool fMaximized, const QUuid &uID);
        ...
        bool setMenuBarContextMenuEnabled(bool fEnabled, const QUuid &uID);
        ...
        bool setDistinguishMachineWindowGroups(const QUuid &uID, bool fEnabled);
#endif /* VBOX_WS_NIX */
        ...
        bool setGuestScreenAutoResizeEnabled(bool fEnabled, const QUuid &uID);
        ...
        bool setLastGuestScreenVisibilityStatus(ulong uScreenIndex, bool fEnabled, const QUuid &uID);
        ...
        bool setLastGuestScreenSizeHint(ulong uScreenIndex, const QSize &sizeHint, const QUuid &uID);
        ...
        bool setHostScreenForPassedGuestScreen(int iGuestScreenIndex, int iHostScreenIndex, const QUuid &uID);
        ...
        bool setAutoHideMiniToolbar(bool fAutoHide, const QUuid &uID);
        ...
        bool setStatusBarContextMenuEnabled(bool fEnabled, const QUuid &uID);
        ...
        bool setRealtimeDockIconUpdateEnabled(bool fEnabled, const QUuid &uID);
        ...
        bool setRealtimeDockIconUpdateMonitor(int iIndex, const QUuid &uID);
        ...
        bool setDockIconDisableOverlay(bool fDisabled, const QUuid &uID);
#endif /* VBOX_WS_MAC */
    ...
    /** @name Virtual Machine: Session Information dialog
      * @{ */
        ...
        bool setSessionInformationDialogGeometry(const QRect &geometry, bool fMaximized);
    /** @} */

    /** @name Guest Control related dialogs
      * @{ */
        bool setGuestControlProcessControlSplitterHints(const QList<int> &hints);
        ...
        bool setFileManagerVisiblePanels(const QStringList &panelNameList);
    ...
    /** @name Soft Keyboard
      * @{ */
        ...
        bool setSoftKeyboardOptions(bool fShowNumPad, bool fHideOSMenuKeys, bool fMultimediaKeys);
        void softKeyboardOptions(bool &fOutShowNumPad, bool &fOutHideOSMenuKeys, bool &fOutHideMultimediaKeys);
        bool setSoftKeyboardColorTheme(const QStringList &colorStringList);
        QStringList softKeyboardColorTheme();
        bool setSoftKeyboardSelectedColorTheme(const QString &strColorThemeName);
        QString softKeyboardSelectedColorTheme();
        bool setSoftKeyboardSelectedLayout(const QUuid &uLayoutUid);
        QUuid softKeyboardSelectedLayout();
    /** @} */

    /** @name File Manager options
      * @{ */
        bool setFileManagerOptions(bool fListDirectoriesFirst,
    ...
    /** @name Virtual Machine: Close dialog
      * @{ */
        ...
        bool setLastMachineCloseAction(MachineCloseAction machineCloseAction, const QUuid &uID);
    ...
    /** @name VirtualBox: Extra-data Manager window
      * @{ */
        ...
        bool setExtraDataManagerGeometry(const QRect &geometry, bool fMaximized);
        ...
        bool setExtraDataManagerSplitterHints(const QList<int> &hints);
    /** @} */
    ...
    /** @name Virtual Machine: Log Viewer dialog
      * @{ */
        ...
        bool setLogWindowGeometry(const QRect &geometry, bool fMaximized);
    /** @} */

    /** @name Virtual Machine: Log Viewer widget options
      * @{ */
        bool setLogViweverOptions(const QFont &font, bool wrapLines, bool showLineNumbers);
    ...
    /** @name Help Browser
      * @{ */
        bool setHelpBrowserLastUrlList(const QStringList &urlList);
        QStringList helpBrowserLastUrlList();
        bool setHelpBrowserZoomPercentage(int iZoomPercentage);
        ...
        bool setHelpBrowserDialogGeometry(const QRect &geometry, bool fMaximized);
        bool helpBrowserDialogShouldBeMaximized();
        bool setHelpBrowserBookmarks(const QStringList &bookmarks);
        QStringList helpBrowserBookmarks();
    /** @} */

    /** @name Manager UI: VM Activity Monitor and Overview
      * @{ */
        bool setVMActivityOverviewHiddenColumnList(const QStringList &hiddenColumnList);
        QStringList VMActivityOverviewHiddenColumnList();
        bool VMActivityOverviewShowAllMachines();
        bool setVMActivityOverviewShowAllMachines(bool fShow);
        bool setVMActivityMonitorDataSeriesColors(const QStringList &colorList);
        QStringList VMActivityMonitorDataSeriesColors();
        bool VMActivityMonitorShowVMExits();
        bool setVMActivityMonitorShowVMExits(bool fShow);
    /** @} */
...
private:
    ...
    bool setDialogGeometry(const QString &strKey, const QRect &geometry, bool fMaximized);
